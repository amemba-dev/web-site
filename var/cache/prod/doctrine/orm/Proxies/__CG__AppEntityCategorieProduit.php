...
class CategorieProduit extends \App\Entity\CategorieProduit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\CategorieProduit' . "\0" . 'id', '' . "\0" . 'App\\Entity\\CategorieProduit' . "\0" . 'libelle', '' . "\0" . 'App\\Entity\\CategorieProduit' . "\0" . 'produits'];
        }
     ...
     * {@inheritDoc}
     */
    public function setLibelle(string $libelle): \App\Entity\CategorieProduit
    {
