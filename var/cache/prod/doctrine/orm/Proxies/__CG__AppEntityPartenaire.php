...
class Partenaire extends \App\Entity\Partenaire implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'logo', '' . "\0" . 'App\\Entity\\Partenaire' . "\0" . 'etat'];
        }
     ...
     * {@inheritDoc}
     */
    public function setLogo(string $logo): \App\Entity\Partenaire
    {
     ...
     * {@inheritDoc}
     */
    public function setEtat(bool $etat): \App\Entity\Partenaire
    {
