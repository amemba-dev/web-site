...
class Achat extends \App\Entity\Achat implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Achat' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Achat' . "\0" . 'commande'];
        }
     ...
     * {@inheritDoc}
     */
    public function setCommande(\App\Entity\Commande $commande): \App\Entity\Achat
    {
